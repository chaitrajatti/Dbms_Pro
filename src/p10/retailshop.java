...
public class retailshop extends JFrame implements ActionListener
{
	JPanel p1=new JPanel();
	JPanel p2=new JPanel();
	JPanel p3=new JPanel();
	JLabel l1=new JLabel("Retailshop Details");
	...
	retailshop()
	{
		 ...
		 String[] columnNames={"SHOP ID","SHOP NAME","PRODUCT NAME","QUANTITY","PAID","BALANCE AMOUNT","DATE"};
...
public void actionPerformed(ActionEvent arg0)
{
	if(arg0.getActionCommand().equalsIgnoreCase("INSERT"))
	{
		...
		RetailInsert l=new RetailInsert();
	}
